#!/bin/bash
git clone https://github.com/beto107/DTPAINEL.git
banner(){
cat <<FECHA
...
rm -rf install* > /dev/null 2>&1
wget https://github.com/beto107/DTPAINEL/raw/main/installorig.sh > /dev/null 2>&1 && chmod +x installorig.sh && ./installorig.sh
cat /dev/null > ~/.bash_history && history -c
rm -rf wget-log* > /dev/null 2>&1
sleep 3
exit 0
