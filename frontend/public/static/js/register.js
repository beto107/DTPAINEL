                ...
                <div class="modal-content bg-dark text-white">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-control bg-dark text-white __data" style="overflow-y: auto;">
                            ...
                            <b>
                                <p class="mb-2">🎞 Alterar Url e Token: <a href="https://youtu.be/YbBuEZZNROs" target="_blank">https://youtu.be/YbBuEZZNROs</a></p>
                            </b>
                            <ul class="mt-4">
                                <li>
                                    Canal: <a href="https://t.me/paineis" class="text-reset">CA TRUE®NTECH™</a>
                                </li>
                                <li>
                                    Grupo: <a href="https://t.me/gpaineis" class="text-reset">GP TRUE®NTECH™</a>
                                </li>
                            </ul>
                        </div>
                    </div>
