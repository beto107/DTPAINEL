                ...
                <div class="d-flex flex-column gap-2 justify-content-center">
                    <div class="card">
                        <div class="card-body p-2">
                            ...
                            <a href="https://youtu.be/YbBuEZZNROs" class="card-link d-flex justify-content-center">Alterar URL e CREDENCIAIS</a>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-body p-2">
                            ...
                            <a href="https://bitbucket.org/nandoslayer/dtunnelinstall/downloads/DTunnelMod_4.2.5_SSH_Painel.apk" class="btn btn-dark w-100 mt-2">BAIXAR</a>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-body p-2">
                            ...
                            <a href="https://bitbucket.org/nandoslayer/dtunnelinstall/downloads/DTunnelMod_4.2.5_Pro_Painel.apk" class="btn btn-dark w-100 mt-2">BAIXAR</a>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-body p-2">
                            ...
                            <a href="https://bitbucket.org/nandoslayer/dtunnelinstall/downloads/DTunnelMod_4.2.5_V2Ray_Painel.apk" class="btn btn-dark w-100 mt-2">BAIXAR</a>
                        </div>
                    </div>
                </div>
            </div>
